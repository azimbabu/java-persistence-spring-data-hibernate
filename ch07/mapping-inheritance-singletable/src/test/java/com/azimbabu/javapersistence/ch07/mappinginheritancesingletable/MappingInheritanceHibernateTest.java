...
public class MappingInheritanceHibernateTest {
  ...
  void storeLoadEntities() {
    try (SessionFactory sessionFactory = createSessionFactory();
      ...
      List<BillingDetails> billingDetails = session.createQuery("select bd from BillingDetails bd", BillingDetails.class).getResultList();
  ...
  private SessionFactory createSessionFactory() {
    ...
    configuration.configure().addAnnotatedClass(CreditCard.class).addAnnotatedClass(BankAccount.class);
