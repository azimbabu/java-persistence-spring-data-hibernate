...
import com.azimbabu.javapersistence.ch08.mappingcollections.listofstrings.configuration.SpringDataConfiguration;
...
public class MappingCollectionsSpringDataJPATest {
  ...
  void storeLoadEntities() {
    ...
    List<String> images = itemRepository.findImagesNative(item.getId());
